...
export class Image {
    ...
    public async create(request: OpenAI.CreateImageRequest): Promise<OpenAI.ImagesResponse> {
        const _response = await core.fetcher({
            url: urlJoin(environments.OpenAIEnvironment.Production, "/images/generations"),
            method: "POST",
            headers: {
    ...
    public async createEdit(
        ...
        const _response = await core.fetcher({
            url: urlJoin(environments.OpenAIEnvironment.Production, "/images/edits"),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "OpenAI-Organization": await core.Supplier.get(this.options.organization),
    ...
    public async createVariation(
        ...
        const _response = await core.fetcher({
            url: urlJoin(environments.OpenAIEnvironment.Production, "/images/variations"),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "OpenAI-Organization": await core.Supplier.get(this.options.organization),
